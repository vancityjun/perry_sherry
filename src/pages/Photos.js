    ...
    return (
      <section className={this.state.mode + ' content'}>
        ...
        <div className="gallaryWrapper wrapper">
          ...
          <div className="imageBox one" onClick={() => this.setState({ photoIndex: 1, isOpen: true })}>
            <img src={require('../img/_DSC0974-Edit.jpg')} alt="" />
          </div>
          <div className="imageBox" onClick={() => this.setState({ photoIndex: 2, isOpen: true })}>
            <img src={require('../img/_DSC0916-Edit-6.jpg')} alt="" />
          </div>
          <div className="imageBox" onClick={() => this.setState({ photoIndex: 3, isOpen: true })}>
            <img src={require('../img/_DSC0745-Edit.jpg')} alt="" />
          </div>
          <div className="imageBox" onClick={() => this.setState({ photoIndex: 4, isOpen: true })}>
            <img src={require('../img/_DSC0668.jpg')} alt="" />
          </div>
          <div className="imageBox vertical" onClick={() => this.setState({ photoIndex: 5, isOpen: true })}>
            <img src={require('../img/_DSC3155-Edit.jpg')} alt="" />
          </div>
          <div className="imageBox one" onClick={() => this.setState({ photoIndex: 6, isOpen: true })}>
            <img src={require('../img/_DSC0434-Edit.jpg')} alt="" />
          </div>
          <div className="imageBox vertical" onClick={() => this.setState({ photoIndex: 7, isOpen: true })}>
            <img src={require('../img/_DSC0448.jpg')} alt="" />
          </div>
          <div className="imageBox one" onClick={() => this.setState({ photoIndex: 8, isOpen: true })}>
            <img src={require('../img/_DSC1019.jpg')} alt="" />
          </div>
          <div className="imageBox" onClick={() => this.setState({ photoIndex: 9, isOpen: true })}>
            <img src={require('../img/_DSC2788-Edit.jpg')} alt="" />
          </div>
          <div className="imageBox" onClick={() => this.setState({ photoIndex: 10, isOpen: true })}>
            <img src={require('../img/_DSC0567-Edit.jpg')} alt="" />
          </div>
          <div className="imageBox" onClick={() => this.setState({ photoIndex: 11, isOpen: true })}>
            <img src={require('../img/_DSC2709-Edit.jpg')} alt="" />
          </div>
          <div className="imageBox vertical" onClick={() => this.setState({ photoIndex: 12, isOpen: true })}>
            <img src={require('../img/_DSC2389.jpg')} alt="" />
          </div>
          <div className="imageBox" onClick={() => this.setState({ photoIndex: 13, isOpen: true })}>
            <img src={require('../img/_DSC2568-Edit.jpg')} alt="" />
          </div>
          <div className="imageBox" onClick={() => this.setState({ photoIndex: 14, isOpen: true })}>
